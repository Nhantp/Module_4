...
<%--            <td><form:select path="languages" items="${homDienTu.languages}"/>${homDienTu.languages}</td>--%>
            <td><form:select path="languages"/>${homDienTu.languages}</td>
        </tr>
        <tr>
            <td><form:label path="pageSize">Page Size: </form:label></td>
<%--            <td><form:select path="pageSize" items="${homDienTu.pageSize}"/>${homDienTu.pageSize}</td>--%>
            <td><form:select path="pageSize" />${homDienTu.pageSize}</td>
        </tr>
        <tr>
